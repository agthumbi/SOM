$( document ).ready( function() {
    ...
    */                
    ...
    $.martanianShowQuotePopup = function( type ) {    
      ...
      /**
    *
    * show dash form popup
    * 
    */ 
     $.martanianShowDashPopup = function( type ) {    

        var mode = windowWidth > 932 && windowHeight > 670 ? 'fixed' : 'absolute';
        var selecteddashForm = $( '#dash-popup #dash-popup-content .dash-form[data-dash-form-for="'+ type +'"]' );

        $( '#dash-popup #dash-popup-background' ).fadeIn( 300 );
        $( '#dash-popup #dash-popup-content #dash-popup-tabs li[data-dash-tab-for="'+ type +'"]' ).addClass( 'active' );

        if( mode == 'absolute' ) $( 'html, body' ).animate({ 'scrollTop': '0' }, 300 );

        selecteddashForm.show();
        setTimeout( function() {

            if( mode == 'fixed' ) {

                selectedQuoteForm.children( '.dash-form-background' ).css({ 'height': selecteddashForm.height() });
                $( '#dash-popup #dash-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50%', 'marginTop': - ( selecteddashForm.height() / 2 ), 'height': selecteddashForm.height(), 'position': 'fixed' });
            }
                ...
                if( windowWidth > 932 ) {
                    ...
                    $( '#dash-popup #dash-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'height': selecteddashForm.height(), 'position': 'absolute' });
                    selecteddashForm.children( '.dash-form-background' ).css({ 'height': selecteddashForm.height() });
                }
                
                else {
                    
                    if( windowWidth > 582 ) $( '#dash-popup #dash-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'height': selecteddashForm.height(), 'position': 'absolute' });
                    else {
                    
                        $( '#dash-popup #dash-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'height': selecteddashForm.height() + $( '#dash-popup-tabs' ).height() + 50, 'position': 'absolute' });
                    }
                }
            }
    ...
    * 
    */ 
     $.martanianShowLoginPopup = function( type ) {    

        var mode = windowWidth > 932 && windowHeight > 670 ? 'fixed' : 'absolute';
        var selectedLoginForm = $( '#login-popup #login-popup-content .login-form[data-login-form-for="'+ type +'"]' );

        $( '#login-popup #login-popup-background' ).fadeIn( 300 );
        $( '#login-popup #login-popup-content #login-popup-tabs li[data-login-tab-for="'+ type +'"]' ).addClass( 'active' );

        if( mode == 'absolute' ) $( 'html, body' ).animate({ 'scrollTop': '0' }, 300 );

        selectedLoginForm.show();
        setTimeout( function() {

            if( mode == 'fixed' ) {

                selectedQuoteForm.children( '.login-form-background' ).css({ 'height': selectedLoginForm.height() });
                $( '#login-popup #login-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50%', 'marginTop': - ( selectedLoginForm.height() / 2 ), 'height': selectedQuoteForm.height(), 'position': 'fixed' });
            }
                ...
                if( windowWidth > 932 ) {
                    ...
                    $( '#login-popup #login-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'height': selectedLoginForm.height(), 'position': 'absolute' });
                    selectedLoginForm.children( '.login-form-background' ).css({ 'height': selectedLoginForm.height() });
                }
                
                else {
                    
                    if( windowWidth > 582 ) $( '#login-popup #login-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'height': selectedLoginForm.height(), 'position': 'absolute' });
                    else {
                    
                        $( '#login-popup #login-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'height': selectedLoginForm.height() + $( '#login-popup-tabs' ).height() + 50, 'position': 'absolute' });
                    }
                }
            }
    ...
    */                
    ...
    $.martanianHideQuotePopup = function() {
      ...
      /**
    *
    * hide dash form popup
    * 
    */                
    
    $.martanianHideDashPopup = function() {
    
        $( '#dash-popup #dash-popup-content' ).removeClass( 'bounceInDown' ).addClass( 'bounceOutUp' );
        setTimeout( function() {
        
            $( '#dash-popup #dash-popup-background' ).fadeOut( 300 );
            $( '#dash-popup #dash-popup-content' ).css({ 'top': '-10000px' }).removeClass( 'bounceOutUp' );
            $( '#dash-popup #dash-popup-content .dash-form' ).hide();
            $( '#dash-popup #dash-popup-content #dash-popup-tabs li' ).removeClass( 'active' );
     ...
     /**
    *
    * hide login form popup
    * 
    */                
    
    $.martanianHideLoginPopup = function() {
    
        $( '#login-popup #login-popup-content' ).removeClass( 'bounceInDown' ).addClass( 'bounceOutUp' );
        setTimeout( function() {
        
            $( '#login-popup #login-popup-background' ).fadeOut( 300 );
            $( '#login-popup #login-popup-content' ).css({ 'top': '-10000px' }).removeClass( 'bounceOutUp' );
            $( '#login-popup #login-popup-content .login-form' ).hide();
            $( '#login-popup #login-popup-content #login-popup-tabs li' ).removeClass( 'active' );
    ...
    */
    ...
    /**
    *
    * hooks to show login form popup
    *
    */

    $( '*[data-action="show-login-popup"]' ).click( function() {

        var quoteKey = $( this ).data( 'quote-key' );
        if( typeof quoteKey != 'undefined' && quoteKey !== false ) $.martanianShowLoginPopup( quoteKey );
    
    });
    /**
    *
    * hooks to show dash form popup
    *
    */

    $( '*[data-action="show-dash-popup"]' ).click( function() {

        var quoteKey = $( this ).data( 'quote-key' );
        if( typeof quoteKey != 'undefined' && quoteKey !== false ) $.martanianShowDashPopup( quoteKey );
    ...
    */
    ...
    $( '#dash-popup-close' ).click( function() {
    
        $.martanianHideDashPopup();
